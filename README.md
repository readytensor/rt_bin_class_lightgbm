# LightGBM Classifier in Scikit-Learn with Shapley Explanations
## Project Description
...
- A **LightGBM** algorithm built using **lightgbm** python package
...
- **`src/`**: This directory holds the source code for the project. It is further divided into various subdirectories:
  ...
  - **`prediction/`**: Scripts for the LightGBM classifier model implemented using **lightgbm** python package.
